...
// 内联函数：逻辑左移
static inline unsigned long SHL(unsigned long x, int n)
{
 ...
 * 私有 F(Lt) 函数：
 * “T 算法” == “L 算法” + “t 算法”。
 * 参数：    [in] a：a 是一个 32 位无符号值；
 * 返回值：  c：c 是通过线性算法 “L” 和非线性算法 “t” 计算得到的。
 */
